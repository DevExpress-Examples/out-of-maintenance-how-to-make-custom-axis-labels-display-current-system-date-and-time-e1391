...
Namespace CustomLabelsText
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
			...
			Dim seriesPoint2 As New DevExpress.XtraCharts.SeriesPoint("B", New Object() { (CObj(3))})
			...
			Dim seriesPoint5 As New DevExpress.XtraCharts.SeriesPoint("E", New Object() { (CObj(1))})
			...
			Me.chartControl1.Size = New System.Drawing.Size(284, 194)
